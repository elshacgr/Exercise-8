...
const styles = StyleSheet.create({
  ...
  contentWrapper: {
    ...
    marginTop: 24, // jarak antara fullname dan signUp
  ...
  addPhoto: {
    ...
    alignItems: 'center', //agar text di tengah
    justifyContent: 'center',
    borderRadius: 90, //agar photo bulat
  },
  avatar: {
    height: 90,
    width: 90,
  ...
  addPhotoText: {
    ...
    fontSize: 14,
    maxWidth: 40, //agar dia kebawah dpe huruf
    textAlign: 'center',
  },
  border: {
    borderWidth: 1,
    ...
    alignItems: 'center',
    justifyContent: 'center',
    borderStyle: 'dashed', //border garis-garis
  },
  avatarWrapper: {
    alignItems: 'center',
    marginTop: 26,
